...
// ---------------------------------------------------------------------------
// Design: "Signal" — a technical-journal reading page that shares its dark
// shell, type colors, and card language with the Categories grid, so moving
// from list → detail feels like one continuous product. The accent color
// (rail, dot, annotation border) switches per category to match that
// category's badge color on the grid.
// ---------------------------------------------------------------------------
...
const BlogDetails = () => {
  ...
  const accent = categoryAccents[blog?.cat] || categoryAccents.technology;
  ...
  return (
    <div
      className="sg-shell"
      style={{ "--signal": accent.base, "--signal-dim": accent.dim }}
    >
      <style>{styles}</style>
      ...
      <div className="sg-frame">
        ...
        <div className="sg-main" ref={articleRef}>
          ...
          <div className="sg-meta-row">
            <span className="sg-eyebrow">{blog.cat}</span>
          ...
          <p className="sg-body">{blog.fullDesc || blog.desc}</p>

          {blog.extra && (
            <aside className="sg-annotation">
              <div className="sg-annotation-tag">
                TRENDLINE // WORTH KNOWING
              </div>
                ...
                {related.map((r) => (
                  ...
                  >
                    ...
                    <span className="sg-index-text">
                      ...
                      <span className="sg-index-cat">{r.cat}</span>
                    </span>
